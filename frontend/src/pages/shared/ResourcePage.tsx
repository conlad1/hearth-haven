    ...
    <div className="mx-auto max-w-5xl space-y-12 px-4 py-16">
      ...
      <div className="card">
        ...
        <ul className="space-y-3 text-sm">
          ...
          <li>
            <strong>Text:</strong> "HELP" to 233733
          </li>
          <li>
      ...
      <div className="card">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          For safety reasons, exact safehouse addresses are not publicly listed.
          We currently support survivors across these regions:
        </p>
        ...
        {regions.length > 0 ? (
          ...
          <p className="mt-4 text-sm text-gray-500 dark:text-gray-400">
            Region information is currently unavailable. Please call a hotline
            or contact us directly to be connected to a secure shelter near you.
          </p>
        )}
      </div>
